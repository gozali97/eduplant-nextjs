...
export default function ReferencesPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-background to-muted/30 p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <Card className="h-full border-none shadow-xl bg-white/60 dark:bg-card/60 backdrop-blur-xl">
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-4">
                  {data.items.map((item, index) => (
                    <div
                      key={index}
                      className="group flex items-start gap-4 p-4 rounded-xl bg-background/50 hover:bg-primary/5 border border-transparent hover:border-primary/20 transition-all duration-300"
                    >
